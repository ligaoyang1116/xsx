...
public class MyTaskP<T> extends AsyncTask<T,T,String> {
        String mPath;
        Context mContext;
        String pswd,name;
        ...
        View mView;
        //获取接口
        public MyTaskP setTaskListener(TaskListeners taskListener ){
            this.taskListener = taskListener ;
            return this;
        }
        public MyTaskP(String mPath, String name,String pswd) {
            this.mPath=mPath;
            this.name=name;
            this.pswd=pswd;
        }
